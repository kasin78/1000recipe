...
public class RecipeDaoImpl implements RecipeDao {
	...
	public List<Recipe> selectAllRecipe() {
		...
		String SELECT_ALL_RECIPE = "SELECT * FROM recipe"; // recipe 테이블 전체 검색
	...
	@Override
	public Recipe selectOneRecipe(long recipe_id) {
	...
	public void countUpdate(int viewCount, long recipe_id) {
