...
<html>
  ...
  <body>
              ...
              <table class="table project-table table-centered table-nowrap">
                ...
                <tbody>
                  <c:forEach var="board" items="${boards}">
                    <tr>
                      <th scope="row"><c:out value="공지사항" /></th>
                      <td>
                        <a href="<%=request.getContextPath()%>/board?action=selected&num=<c:out value='${board.num}'/>" class="btn btn-info btn-sm">
                      ...
                      <c:if test="${who == 'admin'}">
                        ...
                        <td>
                          <a href="<%=request.getContextPath()%>/board?action=delete&num=<c:out value='${board.num}'/>" onclick="return confirm('정말 삭제하시겠습니까?');" class="btn btn-info btn-sm"> 삭제 </a>
                        </td>
                      </c:if>
                    </tr>
                  </c:forEach>
    ...
    <c:if test="${who == 'admin'}">
      <div>
        <button type="button" class="btn btn-info" onclick="location.href='<%=request.getContextPath()%>/admin/adminBoardWrite.jsp'">글쓰기</button>
      </div>
    </c:if>
