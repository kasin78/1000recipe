...
<html>
  ...
  <body>
                ...
                <tbody>
                  <c:forEach var="board" items="${boards}">
                    <tr>                     
                      ...
                      <td>
                        <a href="<%=request.getContextPath()%>/(처리할 컨트롤러)?action=(미정)&num=<c:out value=${board.num}" />
                      ...
                      <td>
                        <a href="<%=request.getContextPath()%>/(처리할 컨트롤러)?action=(미정)&num=<c:out value=${board.num}" /> class="btn btn-danger btn-sm">삭제</a>
                      </td>                    
                    </tr>
                  </c:forEach>
                </tbody>
    ...
    <!-- 검색창 -->
    <div>
      <form action="<%=request.getContextPath()%>/(처리할 컨트롤러)?action=(미정)" method="get">
