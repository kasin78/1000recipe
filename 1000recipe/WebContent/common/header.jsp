              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form id="update" action="<%=request.getContextPath()%>/info" method="post">
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        <input type="password" class="form-control" id="PW9" name="password" autocomplete="off" value="<%= info.getPassword() %>" />
                        <div>비밀번호</div>
                      </div>
                    </div>
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        <input type="password" class="form-control" id="PWCheck2" name="PWCheck" autocomplete="off" value="<%= info.getPassword() %>" />
                        <div>비밀번호확인</div>
                      </div>
                    </div>
