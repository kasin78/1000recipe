					...
					<div class="row">
						<div id="allBoard" class="mt-2">
							...
							<table id="notice" class="col-sm-6 mb-2" style="float: left">
								...
								<tr>
									<th scope="col"><img src="img/요리3.jpg" width="100"
										height="100" alt="" /></th>
								...
								<tr>
									<th scope="col"><img src="img/요리4.jpg" width="100"
										height="100" alt="" /></th>
							...
							<table id="freeBoard" class="col-sm-6 mb-2" style="float: left">
								...
								<tr>
									<td scope="col"><img src="img/요리1.jpg" width="100"
										height="100" alt="" /></td>
								...
								<tr>
									<td scope="col"><img src="img/자장면.jpg" width="100"
										height="100" alt="" /></td>
