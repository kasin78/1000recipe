      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <nav id="nav">
              <a class="btn btn-outline-secondary mb-3" href="<%=request.getContextPath()%>/recipes?action=list">전체</a>
              ...
              <button class="btn btn-outline-secondary mb-3" type="button" id="button-addon2" onclick="location.href='<%=request.getContextPath()%>/userboard?action=list'">
                자유게시판
              </button>
              <button class="btn btn-outline-secondary mb-3" type="button" id="button-addon2" onclick="location.href='<%=request.getContextPath()%>/board?action=list'">
                공지사항
              </button>
            </nav>
          </div>
