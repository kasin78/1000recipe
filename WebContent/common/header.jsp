        ...
        <div class="row">
          <div class="col-sm-2">
            ...
            <div id="logo">
              ...
              <a href="<%=request.getContextPath()%>/main.jsp"><span style="font-size: x-large; font-style: oblique" class="ml-3">1000개의 레시피</span></a>           
            </div>
          </div>
          ...
          <div class="col-sm-7">
            ...
            <nav id="nav">
              <a class="btn btn-outline-secondary mb-3 btn-lg me-5" href="<%=request.getContextPath()%>/recipes?action=list">전체</a>
              <a class="btn btn-outline-secondary mb-3 btn-lg me-3" href="<%=request.getContextPath()%>/recipes?action=list&category=1">한식</a>
              <a class="btn btn-outline-secondary mb-3 btn-lg me-3" href="<%=request.getContextPath()%>/recipes?action=list&category=2">중식</a>
              <a class="btn btn-outline-secondary mb-3 btn-lg me-3" href="<%=request.getContextPath()%>/recipes?action=list&category=3">양식</a>
              <a class="btn btn-outline-secondary mb-3 btn-lg me-4" href="<%=request.getContextPath()%>/recipes?action=list&category=4">일식</a>
              
              <button class="btn btn-outline-secondary mb-3 btn-lg me-3" type="button" id="button-addon2" onclick="location.href='<%=request.getContextPath()%>/userboard?action=list'">
                자유게시판
              </button>
              <button class="btn btn-outline-secondary mb-3 btn-lg" type="button" id="button-addon2" onclick="location.href='<%=request.getContextPath()%>/board?action=list'">
                공지사항
              </button>    
            </nav>   
             <!-- 헤더 수정 우측상단 이미지 삽입 -->
             <div style="position:absolute;right:380px; top:37px;">
              <img src="img/shef.png" class="rounded float-right" alt="" style="width: 100px; height: 100px" />              
                        </div>
          </div>
