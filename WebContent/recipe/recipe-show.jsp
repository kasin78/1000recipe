  ...
  <body>
	...
	<br>
  		...
  		<div style="text-align:end ; margin-bottom: 10px;">
  			<c:if test="${who=='user'}">
        	<button id="button" class="btn btn-dark" onclick="location.href='<%=request.getContextPath()%>/recipes?action=delete&id=${recipe.recipe_id}'" >삭제하기</button>
        	<button id="button" class="btn btn-dark" onclick="location.href='<%=request.getContextPath()%>/recipes?action=edit&id=${recipe.recipe_id}'" >수정하기</button>
        	</c:if>
      	</div>
